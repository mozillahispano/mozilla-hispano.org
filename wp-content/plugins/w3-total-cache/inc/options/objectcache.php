            ...
            <tr>
                ...
                <td>
                    <input id="objectcache_lifetime" type="text"
                        <?php $this->sealing_disabled('objectcache') ?> name="objectcache.lifetime" value="<?php echo $this->_config->get_integer('objectcache.lifetime'); ?>" size="8" /> <?php _e('seconds', 'w3-total-cache'); ?>
            ...
            <tr>
                ...
                <td>
                    <input id="objectcache_file_gc" type="text"
                        <?php $this->sealing_disabled('objectcache') ?> name="objectcache.file.gc" value="<?php echo $this->_config->get_integer('objectcache.file.gc'); ?>" size="8" /> <?php _e('seconds', 'w3-total-cache'); ?>
