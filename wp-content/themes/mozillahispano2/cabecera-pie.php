					...
					<ul id="menu-nav" class="clearfix">
						...
						<li><span title="Ayuda a difundir Mozilla en español">Difusión</span>
							<ul class="submenu">
								...
								<li><a href="https://community.mozilla.org/groups/mozilla-hispano/?view=events" title="Eventos Mozilla">Eventos</a></li>
							</ul>
						</li>
						<li><a href="https://discourse.mozilla.org/c/community-portal/mozilla-hispano" title="Foros de discusión">Foros</a></li>
						<li><a href="https://community.mozilla.org/groups/mozilla-hispano/">Comunidad</a></li>
						<li><a href="https://discourse.mozilla.org/t/leeme-como-participar-en-la-comunidad/64161" title="Únete y colabora con Mozilla Hispano">Participa</a></li>
					</ul>
				</div>
				<div id="social">
					<ul>
						...
						<li><a title="Nuestro foro" id="discourse-icon" href="https://discourse.mozilla.org/c/community-portal/mozilla-hispano/304">Nuestro foro</a></li>
						<li><a title="Nuestro portal comunitario" id="community-icon" href="https://community.mozilla.org/groups/mozilla-hispano/">Nuestro portal comunitario</a></li>
						<li><a title="Nuestra herramienta de chat" id="matrix-icon" href="https://chat.mozilla.org/#/room/#mozilla-hispano:mozilla.org">Nuestra herramienta de chat</a></li>
						<li><a title="Feed RSS" id="rss-icon" href="https://www.mozilla-hispano.org/feed/">Feed RSS</a></li>
					</ul>
				</div>
</div>
PINTA;
...
$temp= <<<PINTA
	...
	<link rel="alternate" type="application/rss+xml" title="Noticias de Mozilla Hispano" href="https://www.mozilla-hispano.org/feed/" />
