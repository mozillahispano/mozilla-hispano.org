...
function smw_makeSortable( table ) {
	...
	for ( var i = 0; i < firstRow.cells.length; i++ ) {
		...
		'<span class="sortarrow"><img alt="[&lt;&gt;]" src="' + SMW_PATH + '/images/sort_none.gif"/></span></a>&nbsp;<span style="margin-left: 1.4em; margin-right: 1em;">' + cell.innerHTML + '</span>'; // the &nbsp; is for Opera ...
	}
